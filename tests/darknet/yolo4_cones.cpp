...
int main() {
    std::string bin_path  = "yolo4_cones";
    ...
    std::string cfg_path  = std::string(TKDNN_PATH) + "/tests/darknet/cfg/yolov4_cones.cfg";
    std::string name_path = std::string(TKDNN_PATH) + "/tests/darknet/names/cones.names";
